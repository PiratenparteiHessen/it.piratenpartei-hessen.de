...
?>
                            ...
                            <form data-toggle="validator" role="form" id="antrag-email-form">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" pattern="<?php echo $pattern; ?>" class="form-control" id="antrag-email-email" placeholder="E-Mail-Adresse" required>
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group has-feedback">
                        ...
                        <p>
                            <form data-toggle="validator" role="form" id="antrag-mailingliste-form">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input type="email" pattern="<?php echo $pattern; ?>" class="form-control" id="antrag-mailingliste-email" placeholder="E-Mail-Adresse" required>
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group has-feedback">
                        ...
                        <p>
                            <form data-toggle="validator" role="form" id="antrag-mailinglisten-moderation-form">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input type="email" pattern="<?php echo $pattern; ?>" class="form-control" id="antrag-mailinglisten-moderation-email" placeholder="E-Mail-Adresse" required>
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group has-feedback">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input type="email" pattern="<?php echo $pattern; ?>" class="form-control" id="antrag-mailinglisten-moderation-mod-email" placeholder="E-Mail-Adresse" required>
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group has-feedback">
                        ...
                        <p>
                            <form data-toggle="validator" role="form" id="antrag-mailinglisten-schreibrechte-form">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input type="email" pattern="<?php echo $pattern; ?>" class="form-control" id="antrag-mailinglisten-schreibrechte-email" placeholder="E-Mail-Adresse" required>
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group has-feedback">
                        ...
                        <p>
                            <form data-toggle="validator" role="form" id="antrag-owncloud-form">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input type="email" pattern="<?php echo $pattern; ?>" class="form-control" id="antrag-owncloud-email" placeholder="E-Mail" required>
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group has-feedback">
            ...
            <div role="tabpanel" class="tab-pane" id="kontakt-email">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p>Uns erreichst du entweder über das nachfolgende Formular oder direkt per E-Mail unter <a href="mailto:it@piratenpartei-hessen.de">it@piratenpartei-hessen.de</a> (PGP: <a href="pgp/Piratenpartei_Hessen_IT_2023-2024_it@piratenpartei-hessen.de_(0xB53096BC)_pub.asc" target="_blank">ID 0xB53096BC</a>, Fingerprint BEE1 2BB5 6849 B211 677D 6573 F9E1 F615 B530 96BC) und <a href="https://twitter.com/HessenIT">Twitter <span class="glyphicon glyphicon-new-window" aria-hidden="true"></span></a>.</p>
                        <p>
                        ...
                        <p>
                            <form data-toggle="validator" role="form" id="kontakt-email-form">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input type="email" pattern="<?php echo $pattern; ?>" class="form-control" id="kontakt-email-email" placeholder="E-Mail-Adresse" required>
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group has-feedback">
